...
<a href="https://calendly.com/support-blueridgetech" class="block h-full no-underline hover:no-underline">
  <div class="flex items-start gap-3">
    {{< icon name="shield-check" class="mt-1 shrink-0 [&_svg]:w-6 [&_svg]:h-6" title="Virus and malware removal" >}}
    <div>
      <h2 class="mt-0">Virus and Malware Removal</h2>
      <p>Thorough cleanup of malware, pop‑ups, and browser hijacks. I add practical protections and tips so the issue doesn’t come back.</p>
    </div>
  </div>
</a>
...
<a href="https://calendly.com/support-blueridgetech" class="block h-full no-underline hover:no-underline">
  <div class="flex items-start gap-3">
    {{< icon name="circle-check-big" class="mt-1 shrink-0 [&_svg]:w-6 [&_svg]:h-6" title="Windows install and setup" >}}
    <div>
      <h2 class="mt-0">Windows Install &amp; Setup</h2>
      <p>Clean installs and upgrades with drivers, updates, and essential apps. I move documents and set preferences the way you like.</p>
    </div>
  </div>
</a>
