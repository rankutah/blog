---
title: "Insurance and Grants | Funding Options for ABA Therapy in Utah — Breaking Barriers Therapy"
description: "Learn about available insurance coverage and grant opportunities for ABA therapy services in Utah. Our comprehensive guide provides valuable information on navigating insurance policies and accessing grants to support the cost of therapy. Explore options to ensure affordability and accessibility for your loved ones' treatment needs."
layout: flowbite
url: "/insurance"
hero: true
---
...
Our Insurance specialist is here to help along the way.

## Insurance

{{< cols min="19rem" gap="1.5rem" v="start" stagger="false" >}}

{{< col card="true" y="start" >}}
### For ABA Services, we work with the following insurances:
...
*   Health Utah
*   EMI
*   United Healthcare (UMR GEHA)
*   U of U healthy premier
*   U of U healthy Preferred
*   Multiplan
*   Medicaid
{{< /col >}}

{{< col card="true" y="start" >}}
### For Speech and Occupational Therapy Services, we work with the following insurances:

*   Tricare
*   Blue Cross Blue Shield Regence
*   EMI
*   Health Utah (Direct Care Administrators, Motiv)
*   Health West
*   Multiplan
*   PEHP
*   PHCS
...
*   U of U: Healthy Premier
*   U of U: Healthy Preferred
*   Utah Fits All Grant/Scholarship
{{< /col >}}
...
Bring your insurance questions, grant questions, and therapy goals to our team. We can help you understand options and decide what makes the most sense for your family.

{{< button url="/contact" text="Contact Us" variant="outline" >}}
{{< /col >}}

{{< /cols >}}

#### Did you know there are grant programs available to you?

Visit the links below for more information on these fantastic
non-profit organizations for available grant programs.
...
We accept cash, debit, credit cards, HSA, FSA, and grants.
{{< /col >}}
