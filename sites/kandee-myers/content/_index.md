...
{{< hero img="/media/kandee-myers-utah-state-senate-district-21-city-mobile.jpeg" alt="Kandee Myers" bleed="false" max="md" pad="2xl" padMobile="none" overlay="true" overlayShade="bg-black/45" overlayPos="mobile-bottom" align="center" vh="none" imgStyle="width:100%;" imgClasses="block w-full h-auto object-contain" >}}
...
{{< col card="true" y="start" >}}
### Get involved
Volunteer opportunities, events, and ways to help.
