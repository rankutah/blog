...
- **Aetna** <br>
- **Delta Dental PPO*** (existing patients only) <br>
- **Delta Dental Premier*** (existing patients only) <br>
- **DMBA** <br>
- **Guardian** <br>
- **MetLife** <br>
- **PEHP** <br>
- **Regence Blue Cross Blue Shield** <br>
- **Select Health*** (existing patients only) <br>
- **SunLife** <br>
...
## Submitting & Processing Claims {#claims}
1. Claim sent electronically (usually within 1–2 business days of treatment)
2. Insurance processes and issues Explanation of Benefits (EOB)
3. We apply payment to your account and bill/credit any difference
...
## Estimates vs Final Costs {#estimates}
